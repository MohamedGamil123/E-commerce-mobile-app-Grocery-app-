...
class _UseBottomNavigationBarr_pageState
  ...
  List<Map<String, dynamic>> pages = [
    ...
    {"page": Categories_page(), "tittle": "Categories"},
    {"page": Cart_page(), "tittle": "Cart"},
    {"page": User_page(), "tittle": "Account"}
  ];
  int selectedindex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        ...
        position: BadgePosition.topEnd(top: -12, end: -15),child: Icon(selectedindex == 2 ? IconlyBold.buy : IconlyLight.buy)),
            label: "Cart",
          ),
          BottomNavigationBarItem(
            icon:
